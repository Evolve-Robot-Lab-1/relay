/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 33d589a337ceeb2c7b244ddb27f5bddd)
// Runtime types generated with workerd@1.20260714.1 2026-07-23 nodejs_compat
interface __BaseEnv_Env {
	AGENTS_KV: KVNamespace;
	AI: Ai;
	ASSETS: Fetcher;
	JWT_SECRET: string;
	DURGA_AUTH_URL: string;
	GMAIL_BOT_URL: string;
	...
	GROQ_KEY_2: string;
	GROQ_KEY_3: string;
	RELAY_STORE: DurableObjectNamespace<import("./server").RelayStore>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./server");
		durableNamespaces: "RelayStore";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JWT_SECRET" | "DURGA_AUTH_URL" | "GMAIL_BOT_URL" | "SALES_AGENT_URL" | "GROQ_API_KEY" | "NVIDIA_API_KEY" | "GROQ_KEY_1" | "GROQ_KEY_2" | "GROQ_KEY_3">> {}
}
